...
class CP(object):
    ...
    def __init__(self):
        ...
        print("[Imagination-based Planner]: Initializing")
    ...
    def maybe_save_model(self, savedir, state):
        ...
        logger.log("[Imagination-based Planner]: Saved model in {} seconds\n".format(time.time() - start_time))
    ...
    def record_termianl_data(self, model_step, obs, action, rew, q_values, q_values_dqn, rtree):
        q_action_list = []
    ...
    def test_corner_case(self, test_env, imagine_model):
        # Init DRL
        print("[Imagination-based Planner]: Start Test Corner Case in CARLA!")
        args = self.parse_args()
        savedir = args.save_dir + "_" + args.env
        save_model = True
...
class Log_Replay_Imagine_Model_New:
    ...
    def load_ego_dynamics(self, env, load_step):
        args = self.parse_args()
    ...
    def parse_args(self):
        ...
        parser.add_argument("--save-dir", type=str, default="./corner_buffer", help="directory in which training state and model should be saved.")

        args = parser.parse_args()
        return args

    def train_ego_dynamics(self, env, train_steps):
        args = self.parse_args()
    ...
    def collect_corner_data(self, env):
        ...
        print("[Imagination-based Planner]: Starting record, Please Drive")
        while True:
            obs = np.array(obs)
            ...
            if done:
                ...
                print("[Imagination-based Planner]: Finish Corner Data Collection and Saving")
                break
